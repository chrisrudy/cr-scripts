    ...
    for user_token in unit_token_list:
        ...
        while loop_killer == True:
            ...
            for values in reg_json["entities"]:
                if values["hardware"] == "X2 Hodor"\
                        or values["hardware"] == "Square Square X2 SFD on sdm660_64 (user"\
                        or values["hardware"] == "T2b" or values["hardware"] == "T2":
        ...
        with open("serials.txt", "w") as serial_numbers:
