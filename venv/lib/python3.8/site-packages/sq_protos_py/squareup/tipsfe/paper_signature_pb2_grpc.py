...
class TipsFePaperSignatureListingServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ListTendersAwaitingMerchantTip = channel.unary_unary(
                '/squareup.tipsfe.paper_signature.TipsFePaperSignatureListingService/ListTendersAwaitingMerchantTip',
        ...
        self.CountTendersAwaitingMerchantTip = channel.unary_unary(
                '/squareup.tipsfe.paper_signature.TipsFePaperSignatureListingService/CountTendersAwaitingMerchantTip',
...
class TipsFePaperSignatureListingServiceServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_TipsFePaperSignatureListingServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'squareup.tipsfe.paper_signature.TipsFePaperSignatureListingService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))


 # This class is part of an EXPERIMENTAL API.
class TipsFePaperSignatureListingService(object):
    """Missing associated documentation comment in .proto file."""
    ...
    def ListTendersAwaitingMerchantTip(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/squareup.tipsfe.paper_signature.TipsFePaperSignatureListingService/ListTendersAwaitingMerchantTip',
    ...
    def CountTendersAwaitingMerchantTip(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/squareup.tipsfe.paper_signature.TipsFePaperSignatureListingService/CountTendersAwaitingMerchantTip',
...
class TipsFePaperSignatureBatchServiceStub(object):
    """Missing associated documentation comment in .proto file."""
    ...
    def __init__(self, channel):
        ...
        self.SubmitTipBatch = channel.unary_unary(
                '/squareup.tipsfe.paper_signature.TipsFePaperSignatureBatchService/SubmitTipBatch',
        ...
        self.SubmitTipAndSettleBatch = channel.unary_unary(
                '/squareup.tipsfe.paper_signature.TipsFePaperSignatureBatchService/SubmitTipAndSettleBatch',
        ...
        self.TenderStatus = channel.unary_unary(
                '/squareup.tipsfe.paper_signature.TipsFePaperSignatureBatchService/TenderStatus',
...
class TipsFePaperSignatureBatchServiceServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_TipsFePaperSignatureBatchServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'squareup.tipsfe.paper_signature.TipsFePaperSignatureBatchService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))


 # This class is part of an EXPERIMENTAL API.
class TipsFePaperSignatureBatchService(object):
    """Missing associated documentation comment in .proto file."""
    ...
    def SubmitTipBatch(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/squareup.tipsfe.paper_signature.TipsFePaperSignatureBatchService/SubmitTipBatch',
    ...
    def SubmitTipAndSettleBatch(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/squareup.tipsfe.paper_signature.TipsFePaperSignatureBatchService/SubmitTipAndSettleBatch',
    ...
    def TenderStatus(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/squareup.tipsfe.paper_signature.TipsFePaperSignatureBatchService/TenderStatus',
