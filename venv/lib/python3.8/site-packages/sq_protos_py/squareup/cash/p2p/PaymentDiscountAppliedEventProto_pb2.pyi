...
class PaymentDiscountAppliedEvent(google___protobuf___message___Message):
    DESCRIPTOR: google___protobuf___descriptor___Descriptor = ...
    applied_at: builtin___int = ...
    ...
    def __init__(self,
        *,
        applied_at : typing___Optional[builtin___int] = None,
    ...
    def HasField(self, field_name: typing_extensions___Literal[u"amount",b"amount",u"applied_at",b"applied_at",u"client_id",b"client_id",u"creation_mechanism",b"creation_mechanism",u"customer_token",b"customer_token",u"discount_amount",b"discount_amount",u"payment_token",b"payment_token"]) -> builtin___bool: ...
    def ClearField(self, field_name: typing_extensions___Literal[u"amount",b"amount",u"applied_at",b"applied_at",u"client_id",b"client_id",u"creation_mechanism",b"creation_mechanism",u"customer_token",b"customer_token",u"discount_amount",b"discount_amount",u"payment_token",b"payment_token"]) -> None: ...
type___PaymentDiscountAppliedEvent = PaymentDiscountAppliedEvent
