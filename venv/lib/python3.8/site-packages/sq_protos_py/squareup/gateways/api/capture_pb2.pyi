...
from sq_protos_py.squareup.gateways.api.common_pb2 import (
    Amount as squareup___gateways___api___common_pb2___Amount,
...
from sq_protos_py.squareup.payments.icc_pb2 import (
    CaptureRequestIccData as squareup___payments___icc_pb2___CaptureRequestIccData,
)
...
class CaptureRequest(google___protobuf___message___Message):
    ...
    capture_request_idempotence_key: typing___Text = ...
    service_code: typing___Text = ...
    auth_requested_amount: builtin___int = ...
    ...
    @property
    def amount(self) -> squareup___gateways___api___common_pb2___Amount: ...

    @property
    def icc_data(self) -> squareup___payments___icc_pb2___CaptureRequestIccData: ...
    ...
    def __init__(self,
        *,
        ...
        amount : typing___Optional[squareup___gateways___api___common_pb2___Amount] = None,
        icc_data : typing___Optional[squareup___payments___icc_pb2___CaptureRequestIccData] = None,
        capture_request_idempotence_key : typing___Optional[typing___Text] = None,
        ...
        auth_requested_amount : typing___Optional[builtin___int] = None,
    ...
    def HasField(self, field_name: typing_extensions___Literal[u"account_number",b"account_number",u"amount",b"amount",u"auth_approved_amount",b"auth_approved_amount",u"auth_intent_created_at",b"auth_intent_created_at",u"auth_reason_code",b"auth_reason_code",u"auth_requested_amount",b"auth_requested_amount",u"authorization_code",b"authorization_code",u"batch_requested_at",b"batch_requested_at",u"capture_gateway_transaction_id",b"capture_gateway_transaction_id",u"capture_request_idempotence_key",b"capture_request_idempotence_key",u"chip_card_fallback_indicator",b"chip_card_fallback_indicator",u"customer_presence",b"customer_presence",u"emv_tags",b"emv_tags",u"gateway_state",b"gateway_state",u"icc_data",b"icc_data",u"input_type",b"input_type",u"instrument_type",b"instrument_type",u"item_data",b"item_data",u"itemization_data",b"itemization_data",u"merchant",b"merchant",u"message_type",b"message_type",u"original_gateway_transaction_id",b"original_gateway_transaction_id",u"partial_payment_record",b"partial_payment_record",u"pay_with_square_entry_method",b"pay_with_square_entry_method",u"payment_id",b"payment_id",u"previousAttemptCount",b"previousAttemptCount",u"product_subcategory",b"product_subcategory",u"reader_type",b"reader_type",u"request_uuid",b"request_uuid",u"requested_statement_info",b"requested_statement_info",u"retrieval_reference_number",b"retrieval_reference_number",u"sender_info",b"sender_info",u"service_code",b"service_code",u"tender",b"tender"]) -> builtin___bool: ...
    def ClearField(self, field_name: typing_extensions___Literal[u"account_number",b"account_number",u"amount",b"amount",u"auth_approved_amount",b"auth_approved_amount",u"auth_intent_created_at",b"auth_intent_created_at",u"auth_reason_code",b"auth_reason_code",u"auth_requested_amount",b"auth_requested_amount",u"authorization_code",b"authorization_code",u"batch_requested_at",b"batch_requested_at",u"capture_gateway_transaction_id",b"capture_gateway_transaction_id",u"capture_request_idempotence_key",b"capture_request_idempotence_key",u"chip_card_fallback_indicator",b"chip_card_fallback_indicator",u"customer_presence",b"customer_presence",u"emv_tags",b"emv_tags",u"gateway_state",b"gateway_state",u"icc_data",b"icc_data",u"input_type",b"input_type",u"instrument_type",b"instrument_type",u"item_data",b"item_data",u"itemization_data",b"itemization_data",u"merchant",b"merchant",u"message_type",b"message_type",u"original_gateway_transaction_id",b"original_gateway_transaction_id",u"partial_payment_record",b"partial_payment_record",u"pay_with_square_entry_method",b"pay_with_square_entry_method",u"payment_id",b"payment_id",u"previousAttemptCount",b"previousAttemptCount",u"product_subcategory",b"product_subcategory",u"reader_type",b"reader_type",u"request_uuid",b"request_uuid",u"requested_statement_info",b"requested_statement_info",u"retrieval_reference_number",b"retrieval_reference_number",u"sender_info",b"sender_info",u"service_code",b"service_code",u"tender",b"tender"]) -> None: ...
type___CaptureRequest = CaptureRequest

class CaptureResponse(google___protobuf___message___Message):
    DESCRIPTOR: google___protobuf___descriptor___Descriptor = ...
    ...
    def HasField(self, field_name: typing_extensions___Literal[u"basic_response",b"basic_response"]) -> builtin___bool: ...
    def ClearField(self, field_name: typing_extensions___Literal[u"basic_response",b"basic_response"]) -> None: ...
type___CaptureResponse = CaptureResponse
