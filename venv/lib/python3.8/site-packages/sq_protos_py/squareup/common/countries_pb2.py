...
# source: squareup/common/countries.proto
...
_COUNTRY = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='UY', index=233, number=858,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='UZ', index=234, number=860,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='VA', index=235, number=336,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='VC', index=236, number=670,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='VE', index=237, number=862,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='VG', index=238, number=92,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='VI', index=239, number=850,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='VN', index=240, number=704,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='VU', index=241, number=548,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='WF', index=242, number=876,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='WS', index=243, number=882,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='XT', index=244, number=963,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
