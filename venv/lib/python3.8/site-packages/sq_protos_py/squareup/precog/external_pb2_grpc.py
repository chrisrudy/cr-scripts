...
class PrecogExternalServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetSignalsByAnonymousToken = channel.unary_unary(
                '/squareup.precog.api.PrecogExternalService/GetSignalsByAnonymousToken',
        ...
        self.GetSignalsByMerchantToken = channel.unary_unary(
                '/squareup.precog.api.PrecogExternalService/GetSignalsByMerchantToken',
        ...
        self.GetEventsByAnonymousToken = channel.unary_unary(
                '/squareup.precog.api.PrecogExternalService/GetEventsByAnonymousToken',
        ...
        self.GetEventsByMerchantToken = channel.unary_unary(
                '/squareup.precog.api.PrecogExternalService/GetEventsByMerchantToken',
        ...
        self.PersistEvent = channel.unary_unary(
                '/squareup.precog.api.PrecogExternalService/PersistEvent',
...
class PrecogExternalServiceServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_PrecogExternalServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'squareup.precog.api.PrecogExternalService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))


 # This class is part of an EXPERIMENTAL API.
class PrecogExternalService(object):
    """Missing associated documentation comment in .proto file."""
    ...
    def GetSignalsByAnonymousToken(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/squareup.precog.api.PrecogExternalService/GetSignalsByAnonymousToken',
    ...
    def GetSignalsByMerchantToken(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/squareup.precog.api.PrecogExternalService/GetSignalsByMerchantToken',
    ...
    def GetEventsByAnonymousToken(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/squareup.precog.api.PrecogExternalService/GetEventsByAnonymousToken',
    ...
    def GetEventsByMerchantToken(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/squareup.precog.api.PrecogExternalService/GetEventsByMerchantToken',
    ...
    def PersistEvent(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/squareup.precog.api.PrecogExternalService/PersistEvent',
