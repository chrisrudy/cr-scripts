...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='squareup/api/rpc.proto',
  package='squareup.api',
  syntax='proto2',
  serialized_options=None,
  serialized_pb=_b('\n\x16squareup/api/rpc.proto\x12\x0csquareup.api\x1a\x1asquareup/api/rpc/rpc.protoP\x00')
  ,
  dependencies=[squareup_dot_api_dot_rpc_dot_rpc__pb2.DESCRIPTOR,],
  public_dependencies=[squareup_dot_api_dot_rpc_dot_rpc__pb2.DESCRIPTOR,])
